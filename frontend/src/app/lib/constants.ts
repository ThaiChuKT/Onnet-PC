...
export const PLAN_IDS = {
  ...
  ULTRA_AMD_MONTHLY: 6,
  BASIC_INTEL_MONTHLY: 7,
  BASIC_AMD_MONTHLY: 8,
  BASIC_INTEL_YEARLY: 9,
  BASIC_AMD_YEARLY: 10,
  PRO_INTEL_WEEKLY: 11,
  PRO_AMD_WEEKLY: 12,
  PRO_INTEL_YEARLY: 13,
  PRO_AMD_YEARLY: 14,
  ULTRA_INTEL_WEEKLY: 15,
  ULTRA_AMD_WEEKLY: 16,
  ULTRA_INTEL_YEARLY: 17,
  ULTRA_AMD_YEARLY: 18,
} as const;
...
export const PLAN_DETAILS = {
  ...
  [PLAN_IDS.BASIC_INTEL_MONTHLY]: {
    id: 7,
    planName: "Basic Intel - Monthly",
    specId: SPEC_IDS.BASIC_INTEL,
    durationDays: 30,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.BASIC_AMD_MONTHLY]: {
    id: 8,
    planName: "Basic AMD - Monthly",
    specId: SPEC_IDS.BASIC_AMD,
    durationDays: 30,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.BASIC_INTEL_YEARLY]: {
    id: 9,
    planName: "Basic Intel - Yearly",
    specId: SPEC_IDS.BASIC_INTEL,
    durationDays: 365,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.BASIC_AMD_YEARLY]: {
    id: 10,
    planName: "Basic AMD - Yearly",
    specId: SPEC_IDS.BASIC_AMD,
    durationDays: 365,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.PRO_INTEL_WEEKLY]: {
    id: 11,
    planName: "Pro Intel - Weekly",
    specId: SPEC_IDS.PRO_INTEL,
    durationDays: 7,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.PRO_AMD_WEEKLY]: {
    id: 12,
    planName: "Pro AMD - Weekly",
    specId: SPEC_IDS.PRO_AMD,
    durationDays: 7,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.PRO_INTEL_YEARLY]: {
    id: 13,
    planName: "Pro Intel - Yearly",
    specId: SPEC_IDS.PRO_INTEL,
    durationDays: 365,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.PRO_AMD_YEARLY]: {
    id: 14,
    planName: "Pro AMD - Yearly",
    specId: SPEC_IDS.PRO_AMD,
    durationDays: 365,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.ULTRA_INTEL_WEEKLY]: {
    id: 15,
    planName: "Ultra Intel - Weekly",
    specId: SPEC_IDS.ULTRA_INTEL,
    durationDays: 7,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.ULTRA_AMD_WEEKLY]: {
    id: 16,
    planName: "Ultra AMD - Weekly",
    specId: SPEC_IDS.ULTRA_AMD,
    durationDays: 7,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.ULTRA_INTEL_YEARLY]: {
    id: 17,
    planName: "Ultra Intel - Yearly",
    specId: SPEC_IDS.ULTRA_INTEL,
    durationDays: 365,
    maxHoursPerDay: null,
    isActive: true,
  },
  [PLAN_IDS.ULTRA_AMD_YEARLY]: {
    id: 18,
    planName: "Ultra AMD - Yearly",
    specId: SPEC_IDS.ULTRA_AMD,
    durationDays: 365,
    maxHoursPerDay: null,
    isActive: true,
...
export const SPEC_PLANS_MAP: Record<number, number[]> = {
  [SPEC_IDS.BASIC_INTEL]: [PLAN_IDS.BASIC_INTEL_WEEKLY, PLAN_IDS.BASIC_INTEL_MONTHLY, PLAN_IDS.BASIC_INTEL_YEARLY],
  [SPEC_IDS.BASIC_AMD]: [PLAN_IDS.BASIC_AMD_WEEKLY, PLAN_IDS.BASIC_AMD_MONTHLY, PLAN_IDS.BASIC_AMD_YEARLY],
  [SPEC_IDS.PRO_INTEL]: [PLAN_IDS.PRO_INTEL_WEEKLY, PLAN_IDS.PRO_INTEL_MONTHLY, PLAN_IDS.PRO_INTEL_YEARLY],
  [SPEC_IDS.PRO_AMD]: [PLAN_IDS.PRO_AMD_WEEKLY, PLAN_IDS.PRO_AMD_MONTHLY, PLAN_IDS.PRO_AMD_YEARLY],
  [SPEC_IDS.ULTRA_INTEL]: [PLAN_IDS.ULTRA_INTEL_WEEKLY, PLAN_IDS.ULTRA_INTEL_MONTHLY, PLAN_IDS.ULTRA_INTEL_YEARLY],
  [SPEC_IDS.ULTRA_AMD]: [PLAN_IDS.ULTRA_AMD_WEEKLY, PLAN_IDS.ULTRA_AMD_MONTHLY, PLAN_IDS.ULTRA_AMD_YEARLY],
};
