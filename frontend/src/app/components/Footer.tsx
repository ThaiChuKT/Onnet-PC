      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Giải pháp cho thuê máy tính gaming chuyên nghiệp, uy tín và chất lượng hàng đầu Việt Nam.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground">Cho thuê PC Gaming</li>
              <li className="text-muted-foreground">Cho thuê Laptop Gaming</li>
              <li className="text-muted-foreground">Cho thuê Thiết bị Streaming</li>
              <li className="text-muted-foreground">Tư vấn cấu hình</li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-8 text-center">
          <p className="text-muted-foreground text-sm">
            © 2026 RentPC Pro. Tất cả quyền được bảo lưu.
          </p>
        </div>
      </div>
    </footer>
