...
const features = [
  {
    ...
    description: "Cam kết bảo hành thiết bị và hỗ trợ kỹ thuật trong suốt thời gian thuê.",
  ...
  },
  {
    ...
    description: "Thuê theo giờ, ngày, tuần hoặc tháng với giá ưu đãi hấp dẫn.",
  ...
  },
  {
    icon: Headphones,
    title: "Hỗ Trợ 24/7",
    description: "Đội ngũ kỹ thuật viên sẵn sàng hỗ trợ mọi lúc mọi nơi.",
  ...
  },
  {
    ...
    description: "100% linh kiện chính hãng từ các thương hiệu hàng đầu thế giới.",
  ...
  },
  {
    ...
    description: "Vệ sinh và bảo dưỡng thiết bị thường xuyên đảm bảo hiệu suất tối đa.",
  ...
  },
  {
    icon: Sparkles,
    title: "RGB Tùy Chỉnh",
    description: "Tùy chỉnh ánh sáng RGB theo sở thích cá nhân của bạn.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Chúng tôi cam kết mang đến trải nghiệm tốt nhất với dịch vụ chuyên nghiệp và thiết bị chất lượng cao.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/30 rounded-lg px-6 py-3">
            ...
            <span className="text-foreground">
              Hơn <strong className="text-primary">1000+</strong> thiết bị sẵn sàng phục vụ bạn
            </span>
          </div>
        </div>
      </div>
